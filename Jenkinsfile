            ...
            steps {
                    retry(3) {
                        timeout(time:10, unit: 'MINUTES') {
                            sh 'docker tag nodeapp-dev:trunk sandep1987/nodeapp-prod:latest'
                            sh 'docker push sandep1987/nodeapp-prod:latest'
                            sh 'docker save sandep1987/nodeapp-prod:latest | gzip > nodeapp-prod-golden.tar.gz'
                        }
                    }
